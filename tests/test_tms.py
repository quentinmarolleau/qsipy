...
def test_ev_vhd_perfect_qe(RELATIVE_DIFF=1e-14):
    # check value at zero
    assert tms.ev_vhd_perfect_qe(0, 2) == 0
    assert tms.ev_vhd_perfect_qe(0, 10) == 0
    assert tms.ev_vhd_perfect_qe(0, 100) == 0
    ...
    check = (
        relative_deviation(
            array_tested=tms.ev_vhd_perfect_qe(phi_inputs, 2),
    ...
    check = (
        relative_deviation(
            array_tested=tms.ev_vhd_perfect_qe(phi_inputs, 100),
